...
Description: Solves Traveling Salesman Problem for beam ability path optimization. Uses exact recursive backtracking for ≤8 points, switches to nearest-neighbor heuristic for larger sets. Finds shortest path visiting all enemies and returning to start.
*/
...
public class TSPSolver {
    ...
    public static List<double[]> solveTSP(double startX, double startY, List<double[]> points) {
        ...
        // recursive backtracking explores all permutations, pruning branches that exceed best
