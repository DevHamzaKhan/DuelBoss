...
public class ShopController {
     ...
     * @param buttonId The shop button that was clicked
     * @param player The player character to upgrade
     * @param scoreManager The score manager for currency checks
     * @return A result indicating what happened (includes score if score purchased)
     */
