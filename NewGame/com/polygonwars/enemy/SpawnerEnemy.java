...
public class SpawnerEnemy extends Enemy {
    ...
    private static final double SPAWN_RANGE = 500.0;
    private static final double KEEP_DISTANCE = 300;
    ...
    private static final Color SPAWN_COLOR = new Color(255, 255, 0);
