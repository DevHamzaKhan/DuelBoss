...
Description: Manages game state (menu, playing, game over, how to play, shop).
*/
...
public class GameStateManager {
    ...
    private boolean isGamePaused; // internal pause for beam ability animation
    ...
    // pause is only used internally for beam ability animation
