...
/**
 * Custom AI behavior for Fire Boss with large area attack range
 */
public class FireBossAIBehavior implements AIBehavior {
    private Random random;
    private double aggroRange;
    private double attackRange;
    private double preferredDistance;

    public FireBossAIBehavior() {
    ...
    private void updateCombat(Boss boss, Characters target, ArrayList<Characters> targets) {
        ...
        // Ranged attack disabled (Fire Boss uses melee only)
