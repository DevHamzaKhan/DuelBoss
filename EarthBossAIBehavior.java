...
/**
 * Custom AI behavior for Earth Boss with large area attack range
 */
public class EarthBossAIBehavior implements AIBehavior {
    private Random random;
    private double aggroRange;
    private double attackRange;
    private double preferredDistance;

    public EarthBossAIBehavior() {
        this.random = new Random();
        this.aggroRange = 500;
        this.attackRange = 300;
        this.preferredDistance = 150; // Stay at medium distance
    }
    ...
    private void updateCombat(Boss boss, Characters target, ArrayList<Characters> targets) {
        ...
        // Ranged attack disabled (Earth Boss uses melee only)
